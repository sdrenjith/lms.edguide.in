...
@php
    ...
    $isReadOnly = false;
    // If studentAnswer exists and has answer_data, make the form read-only (for both courses and tests)
    if (isset($studentAnswer) && $studentAnswer->answer_data !== null && $studentAnswer->answer_data !== '') {
        $isReadOnly = true;
    }
@endphp
    ...
    <div class="modern-answer-form">
        ...
        <div class="modern-answer-card">
            <div class="card-content">
                ...
                <!-- Answer Form -->
                <form method="POST" action="{{ isset($formAction) ? $formAction : (isset($test) ? route('filament.student.pages.tests.question.submit', [$test, $question]) : route('filament.student.pages.questions.submit', $question->id)) }}" enctype="multipart/form-data" class="answer-form">
                    @csrf
                            ...
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-yellow-700 mt-1">Your answer has been submitted. (Answer display temporarily disabled for maintenance.)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
